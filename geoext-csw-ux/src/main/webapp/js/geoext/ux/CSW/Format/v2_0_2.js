                    ...
                    readers: {
                        ...
                        "gmd": {
                            "CI_OnlineResource": function(node, obj) {
                                obj.ciOnlineResource = {};
                                this.readChildNodes(node, obj.ciOnlineResource)
                            },
...
//                                "name":null,
                        ...
                        "srv": {
                            ...
                            "SV_OperationMetadata": function(node, obj) {
                                if (!obj.operationMetadata) obj.operationMetadata = [];
                                var omdNode = this.readChildNodes(node);
                                obj.operationMetadata.push(omdNode);
                            },
                            ...
                            "connectPoint": function(node, obj) {
                                if (!obj.connectPoint) obj.connectPoint = [];
                                var connectPoint = this.readChildNodes(node);
                                obj.connectPoint.push(connectPoint);
                            },
                            "*": function(node, obj) {
                                var name = node.localName || node.nodeName.split(":").pop();
                                if (name in this.readers.gmd._createOneChild) {
